...
const rolePermissionConfig = {
    ...
    '/floor_POST': { module: 'role', permission: 'add' },   '/floor_PUT': { module: 'user', permission: 'add' },
    '/generate-qr-code-for-tables_POST': { module: 'user', permission: 'add' },  '/get-tables_POST': { module: 'user', permission: 'add' }, '/table_POST': { module: 'user', permission: 'add' }, '/table_PUT': { module: 'role', permission: 'add' },   '/table_DELETE': { module: 'role', permission: 'add' }
